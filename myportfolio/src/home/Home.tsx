...
import logo from "../assets/images/fikedev.png";
    ...
    <>
      <div className="container max-w-screen-lg mx-auto">
        <div className="flex flex-col justify-center items-center px-8">
          ...
          <h1 className="text-3xl mt-4 text-center font-normal">Hey there! This is Fekadu Laloto.</h1>
          <h3
          ...
          >
            ...
            specializing in <span className="font-medium">full-stack development</span> and{' '}
